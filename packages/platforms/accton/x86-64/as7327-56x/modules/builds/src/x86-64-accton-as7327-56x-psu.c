...
static umode_t as7327_56x_psu_is_visible(const void *drvdata,
...
static const struct hwmon_channel_info *as7327_56x_psu_info[] = {
    HWMON_CHANNEL_INFO(chip, HWMON_C_REGISTER_TZ),
    NULL,
};

static const struct hwmon_ops as7327_56x_psu_hwmon_ops = {
    .is_visible = as7327_56x_psu_is_visible,
};

static const struct hwmon_chip_info as7327_56x_psu_chip_info = {
    .ops = &as7327_56x_psu_hwmon_ops,
    .info = as7327_56x_psu_info,
};
...
static int as7327_56x_psu_probe(struct i2c_client *client)
{
    ...
    data->hwmon_dev = hwmon_device_register_with_info(&client->dev, "as7327_56x",
                                                      NULL, &as7327_56x_psu_chip_info, NULL);
...
void as7327_56x_psu_remove(struct i2c_client *client)
{
    struct as7327_56x_data *data = i2c_get_clientdata(client);

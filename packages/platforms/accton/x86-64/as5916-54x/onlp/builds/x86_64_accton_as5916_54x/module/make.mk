...
x86_64_accton_as5916_54x_INCLUDES := -I $(THIS_DIR)inc -I $(ACCTON_COMMON)/inc
x86_64_accton_as5916_54x_INTERNAL_INCLUDES := -I $(THIS_DIR)src -I $(ACCTON_COMMON)/inc
...
x86_64_accton_as5916_54x_LIBRARIES := accton_common

...
static umode_t as9726_32d_fan_is_visible(const void *drvdata,
		enum hwmon_sensor_types type,u32 attr, int channel)
{
	return 0;
}

static const struct hwmon_channel_info *as9726_32d_fan_info[] = {
	HWMON_CHANNEL_INFO(fan, HWMON_F_ENABLE),
	NULL,
};

static const struct hwmon_ops as9726_32d_fan_hwmon_ops = {
	.is_visible = as9726_32d_fan_is_visible,
};

static const struct hwmon_chip_info as9726_32d_fan_chip_info = {
	.ops = &as9726_32d_fan_hwmon_ops,
...
static int as9726_32d_fan_probe(struct i2c_client *client)
{
	...
	data->hwmon_dev = hwmon_device_register_with_info(&client->dev, 
					"as9726_32d_fan",
					NULL, &as9726_32d_fan_chip_info, NULL);

...
static umode_t as4625_54t_psu_is_visible(const void *drvdata,
...
static const struct hwmon_channel_info *as4625_54t_psu_info[] = {
	HWMON_CHANNEL_INFO(power, HWMON_F_ENABLE),
	NULL,
};

static const struct hwmon_ops as4625_54t_psu_hwmon_ops = {
	.is_visible = as4625_54t_psu_is_visible,
};

static const struct hwmon_chip_info as4625_54t_psu_chip_info = {
	.ops = &as4625_54t_psu_hwmon_ops,
	.info = as4625_54t_psu_info,
};
...
static int as4625_54t_psu_probe(struct i2c_client *client)
{
	...
	data->hwmon_dev = hwmon_device_register_with_info(&client->dev,
											DRVNAME, NULL, &as4625_54t_psu_chip_info, NULL);

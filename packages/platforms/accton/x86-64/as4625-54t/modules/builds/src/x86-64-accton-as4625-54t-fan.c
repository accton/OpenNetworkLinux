...
static umode_t as4625_is_visible(const void *drvdata,
...
static const struct hwmon_channel_info *as4625_fan_info[] = {
    HWMON_CHANNEL_INFO(fan, HWMON_F_ENABLE),
    NULL,
};

static const struct hwmon_ops as4625_fan_hwmon_ops = {
    .is_visible = as4625_is_visible,
};

static const struct hwmon_chip_info as4625_fan_chip_info = {
    .ops = &as4625_fan_hwmon_ops,
    .info = as4625_fan_info,
};

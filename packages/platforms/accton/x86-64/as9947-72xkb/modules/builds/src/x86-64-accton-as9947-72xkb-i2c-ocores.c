...
spinlock_t as9947_72xkb_cpld_access_lock;
EXPORT_SYMBOL(as9947_72xkb_cpld_access_lock);
...
void __iomem    *async_reg = NULL;
EXPORT_SYMBOL(spi_busy_reg);
EXPORT_SYMBOL(async_reg);

int as9947_72xkb_wait_spi(u32 mask, u8 times) {
    u32 data;
    u32 spi_busy_flag = 0;
    u8 max_times = 0;
    max_times = times;
...
EXPORT_SYMBOL(as9947_72xkb_wait_spi);
...
static int wait_cpld(struct ocores_i2c *i2c, u8 times) {
    ...
    as9947_72xkb_wait_spi((pdev->id & 0xFF00) >> 8, times);
                            ...
                            bool polling)
{
    ...
    LOCK(&as9947_72xkb_cpld_access_lock);
    ...
    if (ret) {
        ...
        UNLOCK(&as9947_72xkb_cpld_access_lock);
        return ret;
    }
...
static int __init ocores_i2c_as9947_72xkb_init(void)
{
    ...
    spin_lock_init(&as9947_72xkb_cpld_access_lock);
...
MODULE_LICENSE("GPL");
MODULE_ALIAS("platform:ocores-as9947-72xkb");

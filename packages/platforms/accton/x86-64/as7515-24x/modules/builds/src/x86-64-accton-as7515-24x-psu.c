...
static umode_t as7515_24x_psu_is_visible(const void *drvdata,
...
static const struct hwmon_channel_info *as7515_24x_psu_info[] = {
	HWMON_CHANNEL_INFO(power, HWMON_F_ENABLE),
	NULL,
};

static const struct hwmon_ops as7515_24x_psu_hwmon_ops = {
	.is_visible = as7515_24x_psu_is_visible,
};

static const struct hwmon_chip_info as7515_24x_psu_chip_info = {
	.ops = &as7515_24x_psu_hwmon_ops,
...
static int as7515_24x_psu_probe(struct i2c_client *client)
{
	...
	data->hwmon_dev = hwmon_device_register_with_info(&client->dev,
											DRVNAME, NULL, &as7515_24x_psu_chip_info, NULL);
...
static void as7515_24x_psu_remove(struct i2c_client *client)
{
	struct as7515_24x_psu_data *data = i2c_get_clientdata(client);
